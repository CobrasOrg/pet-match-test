...
class PetMatchPDFGenerator:
    ...
    def create_header(self, elements, styles):
        ...
        subtitle = Paragraph("Facultad de Ingeniería", styles['Heading2'])
    ...
    def create_test_info_table(self, test_name, test_result, test_duration, elements, styles):
        ...
        table.setStyle(TableStyle([
            ...
            ('GRID', (0, 0), (-1, -1), 1, colors.Color(0.2, 0.5, 0.8)),
    ...
    def add_test_flow_description(self, elements, styles):
        ...
        <b>1. Autenticación:</b> Login en el sistema usando credenciales de usuario dueño de mascota (juan@example.com).<br/><br/>
